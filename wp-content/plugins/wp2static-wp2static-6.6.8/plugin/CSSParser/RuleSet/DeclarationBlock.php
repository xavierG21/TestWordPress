...
class DeclarationBlock extends RuleSet
{
    ...
    public function expandFontShorthand()
    {
        ...
        foreach ($aValues as $mValue) {
            ...
            } else if (in_array($mValue, array('bold', 'bolder', 'lighter')) || ($mValue instanceof Size && in_array($mValue->getSize(), range(100, 900, 100)))) {
    ...
    public function expandBackgroundShorthand()
    {
        ...
        foreach ($aValues as $mValue) {
            ...
            } else if (in_array($mValue, array('left', 'center', 'right', 'top', 'bottom')) || $mValue instanceof Size) {
                if ($iNumBgPos == 0) {
