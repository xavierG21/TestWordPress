...
final class Ocean_Sticky_Header {
	...
	public function custom_sticky_style( $style ) {
		...
		if ( $meta = get_post_meta( oceanwp_post_id(), 'osh_sticky_header_style', true ) ) {
			$style = $meta;
		}
	...
	public function custom_sticky_effect( $sffect ) {
		...
		if ( $meta = get_post_meta( oceanwp_post_id(), 'osh_sticky_header_effect', true ) ) {
			$sffect = $meta;
		}
	...
	public function header_classes( $classes ) {
		...
		// If custom header created with Elementor Pro 2.0
		if ( class_exists( 'ElementorPro\Plugin' )
			&& ( function_exists( 'elementor_location_exits' ) || elementor_location_exits( 'header', true ) ) ) {
