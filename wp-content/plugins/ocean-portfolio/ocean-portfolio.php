...
final class Ocean_Portfolio {
	...
	public static function scripts() {
		...
		wp_register_style( 'photoswipe', plugins_url( '/assets/photoswipe/photoswipe.min.css', __FILE__ ) );
		wp_register_style( 'photoswipe-default-skin', plugins_url( '/assets/photoswipe/default-skin/default-skin.min.css', __FILE__ ) );
		wp_register_script( 'photoswipe', plugins_url( '/assets/photoswipe/photoswipe.min.js', __FILE__ ), array(), OP_VERSION, true );
		wp_register_script( 'photoswipe-ui-default', plugins_url( '/assets/photoswipe/photoswipe-ui-default.min.js', __FILE__ ), array(), OP_VERSION, true );
		...
		if ( is_page_template( 'portfolio-template.php' )
			...
			// Remove Magnific Popup scripts, no need two lightbox scripts
